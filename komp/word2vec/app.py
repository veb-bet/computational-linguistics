...
PATH1 = '/home/kate/models/w2v'
PATH = '/home/kate/models/'
...
def start():
    ...
    input_file = spark.sparkContext.wholeTextFiles('/home/kate/samples/*.txt')
    ...
    model_name = today.strftime("/home/kate/models/w2v")
